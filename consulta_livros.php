...
<?php require "crud/verifica_cliente.php";?>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Biblyos - Cliente - Gerencia Livros</title>
<style type="text/css">
...
<form id="documento" name="documento" method="post" action="crud/incluir_livro_cliente.php?email=<?php echo $_SESSION["email_usuario"]; ?>" onsubmit="return is_cnpj(document.documento.CNPJ.value); return false;">
  <table width="100%" border="0">
      <tr><div align="center"><img src=img/logo.png></div></tr>
	  <tr>	  
	  <div class="topnav">
		<a class="active" href="consulta_livros.php">Ver Livros</a>
    ...
    <tr>
      ...
      <td width="835"><input name="nome_livro" type="text" id="nome_livro" value="" size="45" title="Digite o nome do livro" maxlength="80" required=""/>
        <span class="style1">*</span></td>
    </tr>
	<tr>
      <td width="138">Autor do Livro:</td>
      <td width="835"><input name="autor" type="text" id="autor" value="" size="50" title="Digite o nome do autor" maxlength="80" required=""/>
        <span class="style1">*</span></td>
    </tr>	
    <tr>
...
.keypress(function(e){ // evento ao presionar uma tecla válida keypress
   ...
   if(k == 13){ // se for ENTER
	...
	while($aux = mysqli_fetch_assoc($sql)) { 
		...
		if($aux["cadastrador"] == $_SESSION["email_usuario"]){
			echo '<td align=center><a href=edicao_cliente.php?id='.$aux['id'].'><img src=img/editar.png></a></td>';
			echo '<td align=center><a href=crud/deletar_cliente.php?id='.$aux['id'].'><img src=img/excluir.png></a></td>';		}
		else{
			echo '<td align=center><img src=img/editar.png></a></td>';
			echo '<td align=center><img src=img/excluir.png></a></td>';
		}
		echo '</tr>';
		}
